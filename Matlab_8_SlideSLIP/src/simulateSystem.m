        ...
        switch state
            ...
            case 'stance'
                ...
                if ie == 1
                    ...
                    x_d_init = l_d_vals(end)*cos(phi_vals(end)) + phi_d_vals(end)*l_vals(end)*sin(phi_vals(end)); %*
                    z_d_init = l_d_vals(end)*sin(phi_vals(end)) + phi_d_vals(end)*l_vals(end)*cos(phi_vals(end)); %*
